...
e:Button("Elder Vampire",function()
fireclickdetector(game:GetService("Workspace").Corpse.ClickDetector)
end)
...
f:Button("Botanist",function()
fireclickdetector(game:GetService("Workspace").NPCs.Trainers.Tlachta.ClickDetector)
end)
f:Button("Druid",function()
fireclickdetector(game:GetService("Workspace").NPCs.Trainers.Fungratia.ClickDetector)
end)
